  ...
  return (
    <div className="relative min-h-screen bg-[#06090f] overflow-hidden flex flex-col">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-[-15%] right-[-5%] w-[500px] h-[500px] rounded-full bg-[#8B1538]/15 blur-[100px] animate-pulse"
          style={{ animationDelay: "1.5s" }}
        />
        <div
          className="absolute top-[40%] left-[40%] w-[300px] h-[300px] rounded-full bg-[#d4af37]/5 blur-[80px] animate-pulse"
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[calc(100vh-72px)] py-16 lg:py-20">
          ...
          <div className={`text-white transition-opacity duration-1000 ${mounted ? "opacity-100" : "opacity-0"}`}>
            ...
            <div className="flex items-center gap-8 lg:gap-12">
              {stats.map((stat, i) => (
                <div key={i} className="text-center">
                  <div className="font-serif text-3xl lg:text-4xl font-bold text-[#d4af37]">
                    {stat.number}
                  </div>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              {["Bar Council Enrolled", "LL.M. Qualified", "High Court Practitioner"].map(
                (badge, i) => (
          ...
          {/* Right Column - Image */}
          <div
            className={`relative transition-opacity duration-1000 delay-300 ${
            ...
            <div className="relative rounded-3xl overflow-hidden border border-[#d4af37]/20 shadow-[0_0_60px_rgba(212,175,55,0.15)]">
              ...
              <div className="absolute bottom-6 left-6 right-6 flex gap-4">
                <div className="flex-1 bg-black/60 backdrop-blur-xl rounded-2xl p-4 border border-[#d4af37]/20">
                  <div className="text-[#d4af37] font-bold text-xl font-serif">
                    Advocate Richa Dhanda
                  </div>
                  <div className="text-white/60 text-xs tracking-wider mt-0.5">
                    Expert Immigration Lawyer
                  </div>
                </div>
                <div className="bg-[#d4af37] rounded-2xl p-4 flex flex-col items-center justify-center min-w-[80px]">
                  ...
                  <div className="text-[#06090f]/70 text-[10px] font-bold tracking-wider text-center">
                    YRS EXP
                  </div>
                </div>
              </div>
      ...
      <div className="relative z-10 border-t border-b border-[#d4af37]/10 bg-white/[0.02] backdrop-blur-sm py-4 overflow-hidden">
        ...
        >
          {[...services, ...services].map((item, i) => (
            <span
              key={i}
              className="text-white/40 text-sm font-medium tracking-widest uppercase flex-shrink-0"
            >
              {item}
            </span>
          ))}
