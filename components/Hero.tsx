          ...
          <div className={`lg:col-span-7 transition-opacity duration-700 ${mounted ? "opacity-100" : "opacity-0"}`}>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-10">
              <button
                ...
                className="bg-transparent text-[#2563eb] hover:text-[#1d4ed8] border border-[#2563eb]/40 hover:border-[#2563eb] font-extrabold text-sm px-7 py-3.5 rounded-xl hover:scale-105 transition-all duration-300 flex items-center gap-2 cursor-pointer shadow-xs"
              >
